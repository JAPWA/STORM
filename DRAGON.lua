...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢\n\27')
local token = io.read()
if token ~= '' then
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢\n\27[0;33;49m')
...
send(msg.chat_id_, msg.id_,'  ✹︙ اصدار سورس عظمه{ 3x☆}')
end
...
keyboard.inline_keyboard = { 
{{text = '● 𝑺𝑨𝑰𝑭',url="t.me/A_L_M_G_H_O_L "}},
{{text = 'SOURCE',url="t.me/Alahzane1"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'SOURCE FEGO',url="t.me/Alahzane1"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/Alahzane1)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔??𝗠𝗔 ♢━━━♢
 اختر الامر الذي تريدها .↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢
ده من الازرار بلاسفل . ♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[● 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ](t.me/Alahzane1)❳ 
