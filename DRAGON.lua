...
{{text = '✵ 𝑬𝑳𝑴𝑨𝑺𝑹𝒀', url="t.me/XxxSpnarxxx"}},
...
send(msg.chat_id_, msg.id_,' ✵ اصدار سورس عظمه{ 4x}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس🌸', url="https://t.me/Alahzane1"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
local Text = [[ 
[قناه سورس عظمه ادخل وتابع الجديد](t.me/Alahzane1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✵ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔', url="t.me/Alahzane1"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Alahzane1)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
local Text = [[
╭╾╾╾[𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝒁𝑴𝑨](https://t.me/Alahzane1)╾╾╾╮
┆
┆[𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑪𝑶𝑼𝑹𝑪𝑬 ??𝒁𝑴𝑨](https://t.me/Alahzane1)
┆
╰╾╾╾[𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝒁𝑴𝑨](https://t.me/Alahzane1)╾╾╾╯
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
مطور السورس المصري للتواصل معاه انبع الزر ال في الاسف ⇊
   ]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✵ 𝑬𝑳𝑴𝑨𝑺𝑹𝒀',url="t.me/XxxSpnarxxx"}}, 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《✵⇓ᎠᎬᏙ ΝᎬᎷᎬ⇓✵》](t.me/Alahzane1)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
t = ' ✵ ملفات السورس عظمه◤━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━◥ \n ◤━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━◥  \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if text == ("رفع عظمه") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع عظمه@(.*)$") and Sudo(msg) then
local username = text:match("^رفع عظمه@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع عظمه(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع عظمه(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل عظمه") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل عظمه@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل عظمه@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل عظمه(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل عظمه(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✵ 𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/Alahzane1"}},
 {{text = 'اضف البوت الي مجموعتك ✵' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝚂𝙾𝚄𝚁𝙲?? 𝙴𝙻𝙼𝙻𝙾𝙺》', url="t.me/Alahzane1"}},
}
local msg_id = msg.id_/2097152/0.5
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'عظمه').." غادر" or text == 'غادر' then  
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'انت الشر علي فكره..💛😌 ') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خلتك جرت وراي..😺💜](t.me/Alahzane1)')
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✵ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ✵',url='http://t.me/Alahzane1'}},
}
...
{
{text = '( source ELMLOK )', url="t.me/Alahzane1"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
