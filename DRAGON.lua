...
io.write('\27[1;31m ⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺  ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,2002118176,2038767028,2094348305,1965534755,2078351596,1124610301}
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺")  
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/timo_019/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
...
local Text = ' ♔تم ارسال الملصق من ⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺ \n - '..Name
...
{{text = ' ♔ 𝙶𝚁𝙾𝚄𝙿',url="t.me/e_L_m_L_o_K"},{text = ' ♔ 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ',url="t.me/eLmLoK0"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♔ 𝚈𝙾𝚄𝚃𝚄𝙱𝙴',url="t.me/IT_ITBOT"},{text = '♔ 𝚃𝙸𝙺 𝚃𝙾𝙺',url="t.me/K0XBOT"}},
{{text = '⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺', url="https://t.me/eLmLoK0"}},
{{text = '♔ 𝙴𝙽𝚂𝚃𝙰',url="t.me/J9bbot"},{text = '♔ 𝙴𝙻𝙺𝚁𝙰𝙽',url="t.me/quran_lbot"}},
{{text = '⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺', url="https://t.me/eLmLoK0"}},
{{text = '♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ♔', url="t.me/eLmLoK0"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'بوت القران' or text == 'المصحف' or text == 'بوت قران' then
local Text = [[
♔ الــيـك بـوت القـران فـي الاسـفل ⇓⇑
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♔ 𝙴𝙻𝙺𝚁𝙰𝙽',url="t.me/quran_lbot"}},
{{text = '♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ♔', url="t.me/eLmLoK0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/timo_019/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
ن ومبرمجين سورس الملوك اتبع الازرار للتواصل معهم ⇓⇑
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♔ 𝚃𝙸𝙼𝙾  ',url="t.me/ttimo_8lby"},{text = '♔ 𝙰𝙱𝙾 𝙴𝙻𝙼𝙰𝙶𝙳',url="t.me/ABO_ELMAGD2"}},
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[♔ 𝚃𝙰𝚆𝙰𝚂𝙾𝙻 𝙴𝙻𝙼𝙻𝙾𝙺](t.me/tawasol_1_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '♔ 𝚃𝙰𝚆𝙰𝚂𝙾𝙻 𝙴𝙻𝙼𝙻𝙾𝙺', url="t.me/tawasol_1_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/timo_019/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/harwen7_7/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
' }\n'..' ♔  الايدي بالصوره  ⇦♔{ '..idph..
' }\n'..' ♔  الرفع  ⇦♔{ '..setadd..
' }\n'..' ♔  الحظر  ⇦♔{ '..banm..' }\n\n ♔❲[♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ](t.me/eLmLoK0)❳ ♔\n ♔ قناة سورس الملوك⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺ \n [ ❲[♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ](t.me/eLmLoK0)❳](t.me/eLmLoK0) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺ \nاضغط علي الاسم ليتم نسخه\n⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺ ٴ\n ♔ ❲[♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ](t.me/eLmLoK0)❳ ♔ ')
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الملوك').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[فل عليك وعلي دماغك..😂👻](t.me/eLmLoK0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/eLmLoK0)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/eLmLoK0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/eLmLoK0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/eLmLoK0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/eLmLoK0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/eLmLoK0)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/eLmLoK0)')
return false
end
end
end
...
keyboard.inline_keyboard = { 
{{text = '⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺', url="https://t.me/eLmLoK0"}},
{{text = 'استوري اخر ♔', callback_data="sasa"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='?? مرحبا اليك استوري  رومنسي 𓆪' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
send(msg.chat_id_, msg.id_,'?? مرحبا اليك استوري  رومنسي 𓆪') 
end 
end,nil) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ♔',url='http://t.me/eLmLoK0'}},
}
...
local Teext =[[
💥 اهلا بك في قسم الاوامر ..↑⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺ 
 اختر الامر الذي تريدها .↑⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺ 
ده من الازرار بلاسفل . ⩹━━━⊶♢𝗘𝗟𝗠𝗟𝗢𝗞♢⊷━━━⩺ 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ](t.me/eLmLoK0)❳ 
]]
keyboard = {} 
...
{
{text = '( source ELMLOK )', url="t.me/eLmLoK0"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[♔ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺 ](t.me/eLmLoK0)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الملوك')
