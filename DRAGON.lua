...
sudo_users = {SUDO,1236115319,1491711183,1900794631,1847624105,@@918}   
...
var = true 
elseif tonumber(user_id) == tonumber(1491711183) then
var = true  
elseif tonumber(user_id) == tonumber(1847624105) then
var = true  
elseif tonumber(user_id) == tonumber(1900794631) then
var = true  
elseif tonumber(user_id) == tonumber(@@918) then
var = true  
...
local UserName = (data.username_ or "sourcelosefir")
...
usertext = '\n 🔥 العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelosefir')..')'
status  = '\n 🔥 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🔥 الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'sourcelosefir')..') \n 🔥 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "لوسيفر")
...
send(msg.chat_id_,0," 🔥 الـعـضو  : {["..data.first_name_.."](T.ME/sourcelosefir)}\n 🔥 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🔥 عذرا  ↚ {["..data.first_name_.."](T.ME/sourcelosefir)}\n 🔥 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
━━━━━↝[𝑳𝑶𝑺𝑬𝑭𝑰𝑹](t.me/sourcelosefir)↜━━━━━
[↝ 𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐨𝐮𝐫𝐜𝐞 𝐥𝐨𝐬𝐞𝐟𝐢𝐫 ](t.me/sourcelosefir)
[↝ 𝐥𝐞𝐠𝐚𝐧𝐝](t.me/L120N)
[↝ 𝐥𝐨𝐬𝐞𝐟𝐢𝐫 ](t.me/Losefirblack)
[↝ 𝐠𝐚𝐬𝐬𝐞𝐫](t.me/gesoO9)
[↝ 𝐥𝐞𝐢𝐥 ](t.me/L_e_i_L0)
[↝ 𝐜𝐡 𝐥𝐨𝐬𝐞𝐟𝐢𝐫](t.me/sourcelosefir)
━━━━━↝[𝑳𝑶𝑺𝑬𝑭𝑰𝑹](t.me/sourcelosefir)↜━━━━━
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹𝐜𝐡 𝐥𝐨𝐬𝐞𝐟𝐢𝐫˼', url="t.me/sourcelosefir"}},
{{text = 'الـمـطـور🔥', url="http://t.me/"..sudos.UserName}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourcelosefir&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'قناه الاستوري' or text == 'استوري اللوسيفر' or text == 'قناه الاستوريهات' or text == 'استوري ليجاند' then 
local Text = [[ 
قناه الاستوري ياروحي 🌚💘
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨ استوري ليجاند  ❩', url="t.me/UU_ZM"}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'المالك لوسيفر' or text == 'المبرمج اللوسيفر' or text == 'لوسيفر' or text == 'المطور لوسيفو' then
local Text = [[
[المطور لوسيفر لو حبب تتواصل معاه اتبع الزر اللي تحت](t.me/Losefirblack)

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹L O S E F I R ˼',url="t.me/Losefirblack"}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'قناه السورس' or text == 'قناة السورس' or text == '━━━━━↝𝑳𝑶𝑺𝑬𝑭𝑰𝑹↜━━━━━' then
local Text = [[
لقناة سورس لوسيفر
اتبع الزر إلى تحت ↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝑪𝑯 ˼', url="t.me/sourcelosefir"}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sourcelosefir&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مبرمج السورس' or text == 'ليجاند' then
local Text = [[
...
if text == 'مطور السورس' or text == 'ليل' then
local Text = [[
[ليل مطور السورس](t.me/gesoO90)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹L E I L˼',url="t.me/gesoO9"}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/gesoO9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مالك السورس' or text == 'جاسر' then
local Text = [[
[جاسر مالك السورس](t.me/gesoO9)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹G A S S E R˼',url="t.me/gesoO9"}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/L_e_i_L0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
[اليك بوتات تحميل 🌜
من جميع المواقع 🌝](t.me/sourcelosefir)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨ بوت اليوتيوب ❤️ ❩',url="t.me/Losefirblack_1_bot"},{text = '❨ بوت تيك توك 🖤 ❩',url="t.me/K0XBOT"}},
...
if text == 'العاب لوسيفر' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' then    
local Text = [[  
 🔥 اهلا في قائمه الالعاب المتطوره سورس لوسيفر 🔥 
...
send(msg.chat_id_, msg.id_, '🔥  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'sourcelosefir')..') \n🔥 تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🔥 تم تعطيل جلب الصوره \n 🔥 تم قفل البوتات  \n 🔥 تم قفل التكرار ،\n 🔥 تم قفل الروابط ،\n 🔥 تم قفل التوجيه ،\n 🔥 تم قفل الملصقات ،\n 🔥 تم قفل المتحركه ،\n 🔥 تم قفل الفيديو ،\n 🔥 تم قفل الفشار ،\n 🔥 تم قفل الانلاين ،\n 🔥 تم قفل تعديل المديا ،\n 🔥 تم وضع التكرار  ،\n 🔥 تم قفل الفارسيه  ،\n 🔥 تم وضع الايدي بدون صوره ،n  \n 🔥 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'sourcelosefir')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'sourcelosefir')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🔥  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sourcelosefir')..') \n 🔥 تـم قفـل التاك بالكتم ')
end,nil)   
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local sourcelosefir = database:get(bot_id..'text:ch:user')
if sourcelosefir then
send(msg.chat_id_, msg.id_,'['..sourcelosefir..']')
else
send(msg.chat_id_, msg.id_,' 🔥 لا تستطيع استخدام البوت \n  🔥 يرجى الاشتراك بالقناه اولا \n  🔥 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
if tonumber(result.sender_user_id_) == tonumber(1847624105) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1900794631) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(@@918) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1491711183) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1900794631) then
send(msg.chat_id_, msg.id_, " 🔥 لا يمكنك حظر مالك السورس\n")
return false 
end
if result.id_ == tonumber(@@918) then
send(msg.chat_id_, msg.id_, " 🔥 لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(1491711183) then
send(msg.chat_id_, msg.id_, " 🔥 لا يمكنك حظر مطور السورس \n")
return false 
end
usertext = '\n 🔥 العضو ← ['..result.title_..'](t.me/'..(username or 'sourcelosefir')..')'
status  = '\n 🔥 تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(1847624105) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1900794631) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(userid) == tonumber(@@918) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1491711183) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مطور السورس عام")
return false 
end
...
if text == "بس ليجاند بيصفي البار" and SudoBot(msg) then 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 1000 
},function(ta,DRAGON) 
x = 0 
local list = DRAGON.members_ 
...
local TextE = "\n━━━━━↝𝑳𝑶𝑺𝑬𝑭𝑰𝑹↜━━━━━\n 🔥 علامة تعني { ✔️ } ملف مفعل\n 🔥 علامة تعني { ✖ } ملف معطل\n 🔥 قناة سورس لوسيفر↓\n".." 🔥 [اضغط هنا لدخول](t.me/sourcelosefir) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🔥 لعضو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelosefir')..')'
status  = '\n 🔥 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🔥 الـعـضو   ↚ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🔥 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelosefir')..')'
...
' }\n'..' 🔥  الايدي بالصوره  ↚ { '..idph..
' }\n'..' 🔥  الرفع  ↚ { '..setadd..
' }\n'..' 🔥  الحظر  ↚ { '..DRGm..' }\n\n 🔥━━━━━↝𝑳𝑶𝑺𝑬𝑭𝑰𝑹↜━━━━━\n 🔥 قناة سورس لوسيفر↓\n [ ❲[𝐒ΘΘ𝐍](t.me/sourcelosefir)❳](t.me/sourcelosefir) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'━━━━━↝𝑳𝑶𝑺𝑬𝑭𝑰𝑹↜━━━━━\nاضغط علي الاسم ليتم نسخه\n━━━━━↝𝑳𝑶𝑺𝑬𝑭𝑰𝑹↜━━━━━ٴ\n 🔥 ❲[𝑳𝑶𝑺𝑬𝑭𝑰𝑹](t.me/sourcelosefir)❳ 🔥 ')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🔥 الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'sourcelosefir')..')'..'\n 🔥 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☘️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelosefir')..') '
...
end --الكود حصري سورس لوسيفريعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'لوسيفر').." الاحصائيات" or text == 'الاحصائيات' then  
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' 🔥 الاحصائيات  \n'..' 🔥 عدد الجروبات  ↚ {'..Groups..'}'..'\n 🔥  عدد المشتركين  ↚ {'..Users..'}'
...
if tonumber(msg.sender_user_id_) == tonumber(1847624105) then
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المالك لوسيفر نن عيني 🥺🤍](t.me/sourcelosefir)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المبرمج ليجاند نن عيني 🥺🤍](t.me/sourcelosefir)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if tonumber(msg.sender_user_id_) == tonumber(1900794631) then
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور ليل نن عيني 🥺🤍](t.me/sourcelosefir)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🔥', url="http://t.me/"..sudos.UserName},
...
if tonumber(msg.sender_user_id_) == tonumber(1491711183) then
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور جاسر نن عيني 🥺🤍](t.me/sourcelosefir)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🔥', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/sourcelosefir)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🔥', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sourcelosefir)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[عضو قميل 🌝💙](t.me/sourcelosefir)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تم قفل التعريص بنجاح 😹😎](t.me/sourcelosefir)') 
return false
end
end
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/sourcelosefir)') 
return false
end

if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/sourcelosefir)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/sourcelosefir)') 
return false
end

if text == 'باي' or text == 'بيي' then
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى??💔](t.me/sourcelosefir)') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/sourcelosefir)') 
return false
end

if text == 'يستا' or text == 'يسطا' then
send(msg.chat_id_,msg.id_, '[قابلتك ع البسطه 😂❤](t.me/sourcelosefir)') 
return false
end

if text == 'وه' or text == 'وهه' then
send(msg.chat_id_,msg.id_, '[بسيفلاح يعره مسمعش صوتكك😹🤸🏻‍♀🙊](t.me/sourcelosefir)') 
return false
end

if text == 'اي' or text == 'ايي' then
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/sourcelosefir)') 
return false
end

if text == 'نعم' or text == 'نعام' then
send(msg.chat_id_,msg.id_, '[نعم الله عليك🙂](t.me/sourcelosefir)') 
return false
end

if text == 'هه' or text == 'ههه' then
send(msg.chat_id_,msg.id_, '[ضحكه مش سالكه 😳😂](t.me/sourcelosefir)') 
return false
end

if text == 'بتحبنيي' or text == 'بتحبني' then
send(msg.chat_id_,msg.id_, '[وهو القمر ميتحبش ؟؟ ❤️😂](t.me/sourcelosefir)') 
return false
end

if text == '🙂' or text == '🙂💔' then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😘❤️](t.me/sourcelosefir)') 
return false
end

if text == 'طاسه' then
send(msg.chat_id_,msg.id_, '[امك حلوة وابوك ورقاصة😂💃🏻](t.me/sourcelosefir)')
return false
end

if text == 'حبكك' or text == 'حبك' then
send(msg.chat_id_,msg.id_, '[حبككك اكترر ❤️](t.me/sourcelosefir)') 
return false
end

if text == 'اخرس' or text == 'اخرص' or text == 'اسكت' then
send(msg.chat_id_,msg.id_, '[هتت لازقه وحطها ع بوئيي😹🙊🤸🏻‍♀](t.me/sourcelosefir)') 
return false
end

if text == 'حبيبيي' or text == 'حبيبي' then
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/sourcelosefir)') 
return false
end

if text == 'حبيبتيي' or text == 'حبيبتي' then
send(msg.chat_id_,msg.id_, '[اوعه ع الجمدان بقا حبيبتي وشغل عالي 🙈❤️](t.me/sourcelosefir)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ياحلولي هي فاكراني انسان ولا اي😹❤️](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعملو اي..😒💔](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بنهش كتاكيت احنا هنا ولا اى😒💔](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..🥺💔](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹🚶🏻‍♀💔](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يقطعني 😹🙆🏻‍♀♥️](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير ياعمري..❤️](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اعدل وشكك ونت بتكلمني 😒](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصلخير اي هيجي منين الخير وانت هنا. 🙂😂](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصل حصوله 😹💜](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لاء متقولش نينينينني😹🏃🏻‍♀♥️](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sourcelosefir)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[لف وارجع تاني م حوارر 😹🚶🏻‍♀♥️](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌝♥️](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/sourcelosefir)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/sourcelosefir)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋??](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي💋🥰](t.me/sourcelosefir)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sourcelosefir)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcelosefir')..')'
local iduser = result.sender_user_id_
...
{
{text = '𓆩𝑳𝑶𝑺𝑬𝑭𝑰𝑹𓆪', url="t.me/sourcelosefir"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
