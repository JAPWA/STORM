...
{{text = 'بوت مصطفى',url="t.me/Bot_JABWA_Bot"}}, 
{{text = 'جروب مصطفى', url="t.me/B_A_R_J_A_B_W_A"}},
{{text = 'قناة مصطفي',url="t.me/POSTAT_MOSTAFA"}}, 
...
if text == 'قسم الاصور' then
local Text = 'مرحب بيك في قسم الاصور'
local Key = {
{'صور ولاد','صور بنات'},
...
keyboard.inline_keyboard = {
{{text = 'المبرمج مصطفى', url="t.me/J_A_B_W_A"}},
{{text = 'بوت تواصل مصطفى',url="t.me/Bot_JABWA_Bot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if not DevSoFi(msg) then
local Text = [[
اسعار السرفرات عند مصطفى
سرفر 2رامه بي 50 جنيه
سرفر 4رامه بي 90 جنيه
سرفر 8 رامه بي 150 جنيه
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج مصطفى', url="t.me/J_A_B_W_A"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/c/1586763473/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
