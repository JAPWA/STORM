...
sudo_users = {SUDO,1549578895,1827953514, 1889254632}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𖣘 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸 𖣘")  
...
Namebot = Taha_Msg[math.random(#Taha_Msg)] 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المـبــرمـج جـابــوا', url="t.me/J_A_B_W_A"}},
{{text = 'تواصـل جـابــوا',url="t.me/TWASLJABWA"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'طه' or text == 'اوسكار' or text == 'اوسكار التونز' or text == '²مبرمج السورس' then
local Text = [[
...
t = "\n ☽ قائمه زوجات الجروب \n ☽═───═❲[𖣘 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸 𖣘 ](t.me/S_a_i_d_i)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
if #list == 0 then
t = " ☽ لا يوجد مايا خليفه بي هاذا الجروب البائس"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
' }\n'..' ☽  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ☽  الرفع  ⇇{ '..setadd..
' }\n'..' ☽  الحظر  ⇇{ '..banm..' }\n\n ☽═───═❲[𖣘 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸 𖣘 ](t.me/S_a_i_d_i)❳═───═ ☽\n ☽ قناة سورس صعيدي⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n [ ❲[𖣘 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸 𖣘 ](t.me/S_a_i_d_i)❳](t.me/S_a_i_d_i) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_, 'اهلا يمعرص تم فتح المنيكه تقدر تتمنيك علي صحابك دلوقتي😪😑') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[غور بقا و انت عامل زي القطه بي 7 ترواح بتموت كام مره..😐🤔](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرحي انا و امك قريب😹💋💃](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بطلع لي امك في الاحلام..🙈😹](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفايه شقط بقا سيبلي حاجه يا اخي❤️😂](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل  زيك يروحي 🌝❤️](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكوني معاكو عشان انا مبضون ..😑😹](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت  ايامك يا نوتي 🤐😪](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ هشش اي يحكاك انت..😹](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بحبكك يروحي و انت بتسمع الكلام 🙈✨](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز بوسه انا كمان 😶💛](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك يكابتن خدوني معاكو 🙂💔](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طب..😥](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ اومال..😹](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اه اي يا جدع عيب قولام الوصخ دي😹💔](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عيب يا عرص..🙄💔](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مبجيش تعالي انتي 😉😇](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اعدل وشك و انت بتكلمني 😒](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اهدا ياوحش ميصحش كدا..😂](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اضحك اضحك هوا حد واخد منها حاجه كلو رايح 😂💔](t.me/S_a_i_d_i)')
return false
end
end
end
...
if text == 'بايو'  or text == 'نبذه' then
...
if Num == 0 then 
Text = ' ☽ لم تقم بأضافه احد يا سالك'
else
Text = ' ☽ عدد جهاتك * ⇇↝ '..Num..' ↜ *'
end
send(msg.chat_id_, msg.id_,Text) 
...
{
{text = 'اوامر القفل و الفتح', callback_data="/help1"},{text = 'تعطيل و تفعيل', callback_data="/help2"},
},
{
{text = '𖣘 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸 𖣘', url="t.me/S_a_i_d_i"},
},
...
{
{text = '𖦹 القائمة الرائيسية 𖦹', callback_data="/help8"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = '𝑩𝒂𝒄𝒌 𖦹', callback_data="/help8"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = '𝚂𝙰𝙸𝙳𝙰', url="t.me/sopowerb0t"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
