...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺ :\na⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺ :\na⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
var = true
elseif tonumber(user_id) == tonumber(1966856869) then
var = true
...
if tonumber(user_id) == tonumber(1962004752) then  
...
local UserName = (data.username_ or "SOURCE_STORM")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ستورم') 
local BANDA_Msg = { 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج بودي', url="t.me/Xx_BoDa_UXB"}},
{{text = 'بوت بودي',url="t.me/Bot_JABWA_Bot"}}, 
{{text = 'جروب بودي', url="t.me/So_body"}},
{{text = 'قناة بودي',url="t.me/SOURCE_STORM"}}, 

}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."https://t.me/Xx_BoDa_UXB&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
if text == "اسعار التنصيب" then
if not DevSoFi(msg) then
local Text = [[
↯ سعر التنصيب علي سورس ستورم ↯
...
{{text = 'مـطـور السـورس', url="t.me/A7maaaaaaaaaaaaaaa"}},
{{text = 'بــوت توصـل بــودي',url="t.me/BUDA_UM_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/SOURCE_STORM/148/163&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{{text = 'قناة سورس ستورم', url="t.me/SOURCE_STORM"}},
...
if DevSoFi(msg) then
local bl = 'مرحبا بك في كيب سورس ستورم 𖥳'
local keyboard = {
{'مـبــرمـج السـورس'},
...
local Text = ' 𖥳 تم ارسال الملصق من ⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n - '..Name
...
local Key = {
{'⇣•-•-•-•⟮قـناه الـبرمجه⟯•-•-•-•⇣'},
{'مـطـور السـورس','مـبــرمـج السـورس'},
{'المالك احمد'},
{'قناة السورس','التواصل'},
{'العوده 𖥳'},
}
...
send(msg.chat_id_, msg.id_,' 𖥳 اصدار سورس ستورم{ 3x☆}')
end
...
local Text = [[ 
[قناه سورس ستورم ادخل وتابع الجديد](t.me/SOURCE_STORM)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SOURCE_STORM)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناة السورس', url="t.me/SOURCE_STORM"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'بــودي مـبــرمـج السـورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if text == 'جـابــوا مـبــرمـج السـورس²' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
مبرمج جـابــوا لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
send(msg.chat_id_, msg.id_,' 𖥳  عدد الجروبات الان  ⇇↝ '..#group..' ↜'..DRAGONk..''..DRAGON..'\n 𖥳  الان عدد الجروبات الحقيقي  ⇇↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ستورم")
...
send(msg.chat_id_,0," 𖥳 الـعـضو  : {["..data.first_name_.."](T.ME/SOURCE_STORM)}\n 𖥳 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖥳 عذرا  ⇇{["..data.first_name_.."](T.ME/SOURCE_STORM)}\n 𖥳 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, " 𖥳 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "SOURCE_STORM")..")\n 𖥳 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n 𖥳 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = [[
اهلا بك في سورس ستورم الجمدان
 عايز بوت بأسعار منسبه وبوت مميز كلمني
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑩𝑶𝑫𝒀',url="t.me/Xx_BoDa_UXB"},{text = '𝑩𝑶𝑻 𝑩𝑶𝑫𝒀', url="t.me/BUDA_UM_BOT"}},
{{text = '𝑨𝑯𝑴𝑬𝑯',url="t.me/A7maaaaaaaaaaaaaaa"},{text = '𝑴𝑨𝑹𝑰𝑨𝑴', url="t.me/M_e_r_oOoOo"}},
{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴', url="t.me/SOURCE_STORM"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖥳' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جـابــوا' or text == 'جابوا' or text == 'مين عملك السورس' or text == 'مبرمح السورس²' then
local Text = [[
جـابــوا مـبــرمـج السـورس² لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
بــودي مـبــرمـج السـورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑫𝑬𝑽 𝑩𝑶𝑫𝒀',url="t.me/Xx_BoDa_UXB"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖥳' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'المطور احمد' or text == 'احمد' or text == 'مطور السورس' or text == 'مـطـور السـورس' then
local Text = [[
احمد مـبــرمـج السـورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑫𝑬𝑽 𝑨𝑯𝑴𝑬𝑯',url="t.me/A7maaaaaaaaaaaaaaa"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖥳' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'مرات بودي' or text == 'مـرات بــودي' or text == 'مـريم' or text == 'مريم' then
local Text = [[
مـريم مـرات بــودي قمـر السـورس 🌔❤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑴𝑨𝑹𝑰𝑨𝑴',url="t.me/M_e_r_oOoOo"}},
...
if text == '⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺' or text == 'عاوز بوت' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس ستورم
...
{{text = '📖كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/SOURCE_STORM"}},
{{text = '📖رواية "واختفى كل شئ"', url="https://t.me/t.me/SOURCE_STORM"}},
{{text = '📖رواية "نيلوفر أسود"', url="https://t.me/t.me/SOURCE_STORM"}},
{{text = '📖رواية"جثة في الفندق"', url="https://t.me/t.me/SOURCE_STORM"}},
{{text = '📖رواية "في القطار السريع"', url="https://t.me/t.me/SOURCE_STORM"}},
...
local Text = [[
مطورين ومبرمجين سورس ستورم اتبع الازرار للتواصل معهم ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'جـابــوا مـبــرمـج السـورس',url="t.me/J_A_B_W_A"}},
{{text = 'بــودي مـبــرمـج السـورس',url="t.me/Xx_BoDa_UXB"}},
{{text = 'احمد مـبــرمـج السـورس',url="t.me/A7maaaaaaaaaaaaaaa"}},
{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴', url="t.me/SOURCE_STORM"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖥳' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'ستورم' or text == 'سورس مين ده' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس ستورم
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[𝑾𝑬𝑳𝑪𝑶𝑴𝑺 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴](http://t.me/SOURCE_STORM)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴', url="t.me/SOURCE_STORM"}}, 
...
if text == 'العاب ستورم' or text == 'العاب ستورم' or text == 'العاب المتطوره' then  
local Text = [[  
↯ اهلا في قائمه الالعاب المتطوره سورس ستورم ↯
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[معاك مطور البوت اهو ياروحي ⇈⇊](t.me/SOURCE_STORM)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
t = ' 𖥳 ملفات السورس ستورم ⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n ⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 𖥳 اهلا بك في متجر ملفات ستورم\n 𖥳 ملفات السورس ⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n 𖥳 علامة تعني { ✔️ } ملف مفعل\n 𖥳 علامة تعني { ✖ } ملف معطل\n 𖥳 قناة سورس ستورم⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n".." 𖥳 [اضغط هنا لدخول](t.me/SOURCE_STORM) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖥳 عذرا الملف لايدعم سورس ستورم\n") 
end
return false
end
...
if text == ("مسح قائمه ستورم") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖥳 تم مسح قائمه ستورم')
return false
end

if text == 'قائمه ستورم' and Sudo(msg) then
...
if #list == 0 then
t = " 𖥳 لا يوجد احد في قائمه ستورم"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع ستورم") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ستورم@(.*)$") and Sudo(msg) then
local username = text:match("^رفع ستورم@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ستورم(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ستورم(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ستورم") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ستورم@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ستورم@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ستورم(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ستورم(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n 𖥳 قائمه زوجات الجروب \n 𖥳 ═───═❲[𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴](t.me/SOURCE_STORM)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖥳 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_STORM')..')'
...
local text = 
'\n❲[𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴](t.me/SOURCE_STORM)❳'..
'\n⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺'..
...
' }\n'..' 𖥳  الرفع  ⇇{ '..setadd..
' }\n'..' 𖥳  الحظر  ⇇{ '..banm..' }\n\n 𖥳 ═───═❲[𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴](t.me/SOURCE_STORM)❳═───═ 𖥳 \n 𖥳 قناة سورس ستورم⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\n [ ❲[𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴](t.me/SOURCE_STORM)❳](t.me/SOURCE_STORM) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺ٴ\n ☾ ❲[𝐒??𝐔𝐑𝐂𝐄 𝐕𝐎𝐃𝐓𝐊𝐀](t.me/SOURCE_STORM)❳ 𖥳 ')
end
...
end --الكود حصري سورس ستورميعني لو بكتهن راح اعرفك انت الاخذتهن
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/SOURCE_STORM)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك..🌚💘](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..😒♥️](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي..🌚💘](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..🌚♥️](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب😑😂](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب..🙂](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي..🥺💔](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه..🌝😂](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام..😹😹](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك 💘😂](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝💘](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹💔](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي..🤔](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي 💋🥰](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي..🌚💔](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي..💛](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي..🐣😹](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي..🌚💜](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه الستورم](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف..🥺💔](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚💘](t.me/SOURCE_STORM)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص..😂😜](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق..🥰💘](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام..🌚🖤](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال..😹](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ..🙄💔](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم يا مطوري..🥺💔](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح..😹👻](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح..😹👻](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صح النوم..😂](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 🍯🙂](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي..🙂💛](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🥺💔](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺💘](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورك يا قلبي..🌚💘](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه..😹💥](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا..😂](t.me/SOURCE_STORM)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💘](t.me/SOURCE_STORM)')
return false
end
end
end
...
[[
↑⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 𖥳  
↑⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺𝙄𝘿 ➱ #id
↑⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺𝙍𝘼𝙉𝙆 ➱  #stast 𖥳  
↑⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺??𝘼𝙎𝙂 ➱ #msgs 𖥳  
↑⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺𝗖𝗛 ➯  ↝@SOURCE_STORM↜ 𖥳  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
[🎯ألعاب سورس ستورم الاحسن في التليجرام ⇈⇊]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑻𝑶𝑹𝑴](t.me/SOURCE_STORM)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل⩹━━━━━❲𖥳 𝑺𝑻𝑶𝑹𝑴 𖥳❳━━━━━⩺
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," 𖥳 "..DRAGON1_Msg)
