...
sudo_users = {SUDO,1774315810,1827953514, 1889254632}   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹المـبــرمـج جـابــوا˼', url="t.me/QSban"}},
{{text = '˹تواصـل جـابــوا˼',url="t.me/offline1E"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒑𝒑𝒍𝒆 ϟ ](http://t.me/S_a_i_d_i)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⦅ 𖣘 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸 𖣘 ⦆ ', url="t.me/S_a_i_d_i"}}, 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/S_a_i_d_i)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺
 اختر الامر الذي تريدها .↑⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺
ده من الازرار بلاسفل . ⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[⦅ 𖣘 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸 𖣘 ⦆ ](t.me/S_a_i_d_i)❳ 
]]
keyboard = {} 
