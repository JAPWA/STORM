...
io.write('\27[1;31m ♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢  ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
local Text = ' ♔تم ارسال الملصق من ♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ \n - '..Name
...
local Text = [[
مطورين ومبرمجين سورس الملوك اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《♔⇓ᎠᎬᏙ ΝᎬᎷᎬ⇓♔》](t.me/eLmLoK0)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
send(msg.chat_id_, msg.id_, "دا المصري حبيبي")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(2087027101) then  
send(msg.chat_id_, msg.id_, "لا دا المصري حبيبي مينفعش اكتمو ")
return false 
end
usertext = '\n ♔ الـعـضو   ⇦♔['..result.title_..'](t.me/'..(username or 'eLmLoK0')..')'
status  = '\n ♔ تم كتمه عام من الجروبات'
...
t = ' ♔ ملفات السورس الملوك♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ \n ♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢  \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾??𝙰??》', url="t.me/eLmLoK0"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♔ 𝚂𝙾𝚄??𝙲𝙴 𝙴𝙻𝙼𝙻𝙾𝙺', url="t.me/eLmLoK0"}},
}
local msg_id = msg.id_/2097152/0.5
...
[[
↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ 𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ♔  
↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ 𝙄𝘿 ➱ #id
↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ 𝙍𝘼𝙉𝙆 ➱  #stast ♔  
↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ 𝙈𝘼𝙎𝙂 ➱ #msgs ♔  
↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ 𝗖𝗛 ➯  »@eLmLoK0« ♔  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
local Text = [[
 ...
 تحت لي في الزر الأسفل♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/64&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Teext =[[
💥 اهلا بك في قسم الاوامر ..↑♢━━━♢ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗭𝗠𝗔 ♢━━━♢ 
