...
database:srem(bot_id..'C hek:Groups',group[i])  
w = w + 1
end
if #group == i then 
if (w + q) == 0 then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},functonarg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'خيروك أخري', callback_data="/asr4"}}, 
...
local Text ='مرحبا اليك كتابه بالصوره'
keyboard = {}  
keyboard.inline_keyboard = { 
...
if SourceCh(msg) and text == "كلمني" then
...
localؤ msg_id = msg.id_/2097152/0.5 
